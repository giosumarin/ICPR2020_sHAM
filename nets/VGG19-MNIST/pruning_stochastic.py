...
pr_ws_model.apply_pruning_stochastic(list_trainable=model.trainable_weights, untrainable_per_layers=2)
...
with open("VGG19-MNIST_pr_stochastic.txt", "a+") as tex:
    tex.write("{} lr {} cluster {} -->\n {}\n , {}\n\n".format(b,l, c_print, TRAIN_RES, TEST_RES))

DIR="pruningstochastic"
TO_SAVE = "{}-{}-{}".format(p,c_print,round(TEST_RES[-1],2))
