...
TRAIN_RES = ([post_ws_train] + ws_model.acc_train)
TEST_RES = ([post_ws_test] + ws_model.acc_test)


with open("deepdta_davis_st.txt", "a+") as tex:
    tex.write("{} lr {} cluster {} -->\n {}\n , {}\n\n".format(b, l, c_print, TRAIN_RES, TEST_RES))

DIR="stochastic"
TO_SAVE = "{}-{}".format(c_print,round(TEST_RES[-1],5))
